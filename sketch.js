...
function draw() 
{
  ...
  //calculate wattage with a threshold value
  if(panel1_voltage<5)
  {
    //0.75 is just approx val , you can take any value
  ...
  {
    //used only the label , this is one way to do this
    fan.changeAnimation('run');
    //decrease temp by using fan
    temp-=0.5;
  }
